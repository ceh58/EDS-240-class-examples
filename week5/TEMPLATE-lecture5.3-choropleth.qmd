...
pal_brbg11 <- RColorBrewer::brewer.pal(n = 11, name = 'BrBG')
```
...
base_map +
  scale_fill_gradientn(colors = pal_brbg11,
...
# save HEX codes as vector ----
pal_brbg10 <- RColorBrewer::brewer.pal(n = 10, name = 'BrBG')
```
...
base_map +
  scale_fill_stepsn(colors = pal_brbg10,
                    labels = label_percent(scale = 1),
                    #breaks = breaks_width(width = 10),
                    values = rescale(x = c(-40, 0, 20))) +
