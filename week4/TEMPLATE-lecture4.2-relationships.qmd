...
ggMarginal(p1, type = "density") # histogram
```
...
ggMarginal(p2, type = "density", groupFill = FALSE, groupColour = TRUE)
```
...
stream_chem_data |> 
  ...
  ggplot(aes(x = DOC, y = pH, color = site, size = Al_ICP)) + 
  geom_point(alpha = 0.5) +
  scale_size(range = c(1, 10)) + # scales area
